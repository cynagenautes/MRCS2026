...
Weight-only post-training quantization is the dominant strategy for deploying large language models.
GPTQ~\cite{frantar2023gptqaccurateposttrainingquantization} uses approximate second-order error compensation to bring Open Pre-trained Transformer(OPT)~\cite{zhang2022optopenpretrainedtransformer} and BigScience Large Open-science Open-access Multilingual (BLOOM) language model~\cite{NEURIPS2022_ce9e92e3} down to INT4 with minor perplexity loss,
